                            ...
                            <div className={classes.top_content}>
                                <div className={classes.left_content}>
                                    ...
                                    <div className={classes.project_area}>
                                        ...
                                        <span>
                                            제가 진행한 다양한 프로젝트들을 포트폴리오 용도로 정리하기 위해 수행한 프로젝트입니다. 이를 통해 포트폴리오를 보시는 분들에게 제가 어떤 개발자인지에 대해 조금이라도 알려드리고자 합니다.
                                        </span>
                                    </div>
                                    ...
                                    <div className={classes.project_area}>
                                        ...
                                        <span>
                                            저는 주로 Back End를 중심으로 능력을 발전시켰습니다. 초기에는 기존에 있는 포트폴리오 툴을 사용하여 내용을 채워넣을까도 고려하였으나, 저에게 맞는 개인적인 포트폴리오 사이트를 스스로 만들고자 결심하였습니다.<br/><br/>

                                            기술스택으로는 React를 사용한 이유는 컴포넌트 구조 때문입니다. 포트폴리오에는 Skill과 Project등 공통된 부분이 많이 포함됩니다. 이를 공용 컴포넌트로 개발하게 되면 정보를 깔끔하게 유지할 수 있어서 더 나은 사용자 경험을 제공할 수 있다고 판단하였습니다. 또한, React의 컴포넌트 기반 접근 방식은 유지 보수와 확장성 면에서도 우수한 선택이었습니다.
                                        </span>
                                    </div>
                                </div>
