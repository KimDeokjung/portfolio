                            ...
                            <div className={classes.top_content}>
                                <div className={classes.left_content}>
                                    ...
                                    <div className={classes.project_area}>
                                        ...
                                        <span>
                                            같이 직장생활을 했던 동료들과 함께 수행한 프로젝트입니다. 평소 급식카드에 대해 알고 있던 동료의 의견을 출발점으로 하여 기획이 시작되었습니다. 주요 타켓층이 아이들이라는 점을 고려하여, 아이들이 사용하기 편하고 직관적인 서비스를 개발하는 것이 저희의 목표였습니다.
                                        </span>
                                    </div>
                                    ...
                                    <div className={classes.fun_area}>
                                        ...
                                        <div className={classes.fun_list_area}>
                                            ...
                                            <span className={mainPageIndex === 0 ? classes.active_fun_list : classes.hide_area}>
                                                    Deats의 메인페이지 입니다. 로그인이 된 상태라면 헤더 우측을 통해 로그인페이지로 이동 할 수 있습니다. 최근에 올린 공지사항이나 FAQ등을 메인페이지에서 간단하게 보여줍니다.
                                                    <br/><br/>
                                    ...
                                    <div className={classes.project_area}>
                                        ...
                                        <span>
                                            초기 계획은 Front End 개발자 1명, Back End 개발자 2명으로 시작하였습니다. 그러나 디자인 작업이 빨리 진행되어 Front End 개발자가 모든 작업을 담당하기에는 Front End 개발 진행도와 Back End 개발 진행도의 편차가 커질 우려가 있었습니다. 그래서 저는 순수 Back End 개발 역할에서 Front End와 Back End 두 영역을 보조하는 역할로 변경하게 되었습니다.
                                            <br/><br/>
                                            ...
                                            <br/><br/>
                                            Back End 기능을 많이 개발하지 못한 점이 아쉽지만, Front End와 Back End 모두에 개입하면서 중간 중간 생기는 CORS 문제, SSL/TLS 프로토콜을 사용하는 이유 등과 같은 네트워크적인 상황에 대한 대응 능력을 확실히 숙지할 수 있었습니다.
                                            <br/><br/>
