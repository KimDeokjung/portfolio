                                ...
                                <div className={classes.left_content}>
                                    ...
                                    <div className={classes.project_area}>
                                        ...
                                        <span>
                                            ...
                                            <br/><br/>
                                            회사에서 주로 사용하는 기술인 Express와 MongoDB를 선택하여 기술 스택으로 사용했습니다. 개인과제와 외주 업무를 주로 수행하던 기간 이후, 자사 제품을 개발하는 프로젝트에 투입될 예정이었는데, Express와 MongoDB를 처음 접하는 상황에서 팀원들에게 피해를 주지 않고자 해당 기술들의 숙련도를 높이려 노력했습니다.
                                            <br/><br/>
